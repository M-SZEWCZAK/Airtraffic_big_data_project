...
def main():
    ...
    batch_views.append(("serving.delay_airport_month", v1))
    ...
    batch_views.append(("serving.cancel_airport_month", v2))
    ...
    batch_views.append(("serving.top10_airports_delay_month", v3))
    ...
    if v4 is not None:
        ...
        batch_views.append(("serving.delay_weather_region_month", v4))
    ...
    batch_views.append(("serving.delay_carrier_month", v5))
    ...
    if v6 is not None:
        ...
        batch_views.append(("serving.cancel_weather_region_month", v6))
    ...
    if v7 is not None:
        ...
        batch_views.append(("serving.aircraft_age_bucket_carrier_year", v7))
    ...
    print("\n" + "=" * 100)
    print("BATCH VIEWS – PREVIEW (first 20 rows)")
    print("=" * 100)
